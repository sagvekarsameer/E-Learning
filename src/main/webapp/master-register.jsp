...
<div class="container">
    <div class="card register-card">
        <h3 class="text-center mb-4">Register as Master</h3>

        <% String error = request.getParameter("error");
            String success = request.getParameter("success");
            if (error != null) { %>
        <div class="alert alert-danger"><%= URLDecoder.decode(error, "UTF-8") %>
        </div>
        <% } else if (success != null) { %>
        <div class="alert alert-success"><%= URLDecoder.decode(success, "UTF-8") %>
        </div>
        <% } %>
